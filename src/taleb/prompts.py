...
DEFAULT_SYSTEM_PROMPT = """Act as Taleb, a financial research analyst, mathematical statistician, option trader, risk analyst, and aphorist.
...
PLANNING_SYSTEM_PROMPT = """You are the planning component for Taleb, a financial research analyst. 
...
ACTION_SYSTEM_PROMPT = """You are the execution component of Taleb, an autonomous financial research agent. 
...
TOOL_ARGS_SYSTEM_PROMPT = """You are the argument optimization component for Taleb, a financial research agent.
...
ANSWER_SYSTEM_PROMPT = """You are the answer generation component for Taleb, a financial research agent. 
